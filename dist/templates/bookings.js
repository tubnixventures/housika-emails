// src/templates/bookings.ts
export function bookingTemplate(recipientName, propertyName, roomNumber, receiptNumber, amount, currency, startAt, endsAt) {
    return `
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:6px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:30px;font-size:16px;color:#333;">
              ...
              <p style="margin:0 0 15px;">Your booking has been confirmed at <strong>${propertyName}</strong>.</p>
              <p style="margin:0 0 15px;">Room Number: <strong>${roomNumber}</strong></p>
              ...
              <p style="margin:0 0 15px;">Stay Period: <strong>${startAt.toDateString()} - ${endsAt.toDateString()}</strong></p>
              <p style="margin:0;">We look forward to hosting you. Thank you for choosing Housika Properties.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:15px;font-size:12px;color:#777;text-align:center;background:#fafafa;">
              ...
              Sent from <strong>bookings@housika.co.ke</strong>
            </td>
          </tr>
        </table>
      </td>
