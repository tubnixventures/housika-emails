...
export function adminTemplate(taskDetails: string, recipientName: string) {
  return `
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:6px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:30px;font-size:16px;color:#333;">
              ...
              <p style="margin:0 0 15px;">${taskDetails}</p>
              <p style="margin:0;">Please ensure compliance with company policies and complete the required actions promptly.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:15px;font-size:12px;color:#777;text-align:center;background:#fafafa;">
              ...
              Sent from <strong>admin@housika.co.ke</strong>
            </td>
          </tr>
        </table>
      </td>
